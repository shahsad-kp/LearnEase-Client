    ...
    return (
        <div className={'bg-secondary p-2 h-min shadow rounded-md flex flex-row justify-around'}>
            <div className={'w-min flex gap-1 flex-col justify-center cursor-pointer'}
                ...
                <div className={`w-min h-10 box-border p-2 xl:bg-primary rounded${
                    selected === 'participants' ? ' !bg-accent-color-one' : ''
                }`}>
            ...
            <div className={'w-min flex gap-1  flex-col justify-center cursor-pointer'}
                 onClick={() => setSelected('chatting')}>
                <div className={`w-min h-10 box-border p-2 xl:bg-primary rounded${
                    selected === 'chatting' ? ' !bg-accent-color-one' : ''
                }`}>
            ...
            <div className={'w-min flex gap-1  flex-col justify-center cursor-pointer'}
                ...
                <div className={`w-min h-10 box-border p-2 xl:bg-primary rounded${
                    selected === 'documents' ? ' !bg-accent-color-one' : ''
                }`}>
            ...
            <div className={'w-min flex gap-1  flex-col justify-center cursor-pointer'}
                ...
                <div className={`w-min h-10 box-border p-2 xl:bg-primary rounded${
                    selected === 'activities' ? ' !bg-accent-color-one' : ''
                }`}>
